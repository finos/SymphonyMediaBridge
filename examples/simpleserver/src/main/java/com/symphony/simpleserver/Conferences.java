...
public class Conferences {
    ...
    @Autowired
    public Conferences(SymphonyMediaBridge symphonyMediaBridge, Parser parser) {
    ...
    public synchronized String join(boolean bundleTransport, boolean enableDtls, boolean enableIce) throws IOException, ParserFailedException, InterruptedException, ParseException, SmbException {
        ...
        LOGGER.info("Join, endpointId {}, conferenceId {}", endpointId, conferenceId);
            ...
            SmbException
    {
        ...
        /*for (var endpointsEntry : endpoints.entrySet()) {
            ...
            final var offer = parser.makeSdpOffer(lastEndpointDescription,
    ...
    private void sendMessage(String endpointId, String type, String payload) throws
