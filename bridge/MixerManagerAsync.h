...
public:
    ...
    bool asyncAudioStreamRemoved(EngineMixer& mixer, EngineAudioStream& audioStream);
    ...
    bool asyncVideoStreamRemoved(EngineMixer& engineMixer, EngineVideoStream& videoStream);
    bool asyncSctpReceived(EngineMixer& mixer, memory::UniquePacket& msgPacket, size_t endpointIdHash);
    bool asyncDataStreamRemoved(EngineMixer& mixer, EngineDataStream& dataStream);
    bool asyncFreeRecordingRtpPacketCache(EngineMixer& mixer, uint32_t ssrc, size_t endpointIdHash);
    bool asyncBarbellRemoved(EngineMixer& mixer, EngineBarbell& barbell);
