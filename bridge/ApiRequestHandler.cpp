    ...
    const std::string& endpointId)
{
    ...
    if (allocateChannel._bundleTransport.isSet())
    {
        ...
        responseDtls.hash = _sslDtls.getLocalFingerprint();
    ...
    const std::string& barbellId)
{
    ...
    return generateBarbellResponse(requestLogger, *mixer, conferenceId, barbellId, iceRole == ice::IceRole::CONTROLLED);
}
    ...
    const api::EndpointDescription& barbellDescription)
{
    ...
    return generateBarbellResponse(requestLogger, *mixer, conferenceId, barbellId, !isRemoteSideDtlsClient);
}
