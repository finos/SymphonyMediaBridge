...
EngineMixer::EngineMixer(const std::string& id,
    ...
    : _id(id),
      ...
      _incomingRtcp(isVideoDisabled ? maxPendingRtcpPacketsVideoDisabled : maxPendingRtcpPackets),
      _incomingForwarderVideoRtp(isVideoDisabled ? 0 : maxPendingPackets),
      _engineAudioStreams(maxStreamsPerModality),
      _engineVideoStreams(isVideoDisabled ? 0 : maxStreamsPerModality),
      ...
      _ssrcInboundContexts(isVideoDisabled ? maxSsrcsVideoDisabled : maxSsrcs),
      _allSsrcInboundContexts(isVideoDisabled ? maxSsrcsVideoDisabled : maxSsrcs),
